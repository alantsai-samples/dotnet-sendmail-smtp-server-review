# 參與 dotnet-sendmail-smtp-server-review
...
如果您在這個專案裡面找到任何bug或者想要針對任意地方提出建議/意見，歡迎透過[開issue](https://github.com/alantsai/dotnet-sendmail-smtp-server-review/issues/new) 或者 可以在 [gitter](https://gitter.im/alantsai/dotnet-sendmail-smtp-server-review?utm_source=share-link&utm_medium=link&utm_campaign=share-link)上面發問。
